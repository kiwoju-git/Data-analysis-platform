...
METHOD_VERSIONS: dict[str, str] = {
    ...
    "hypothesis.equivalence_tost": "0.2.0",
    ...
    "doe.factorial_design": "0.8.0",
    "doe.general_factorial_design": "0.3.0",
...
METHODS: tuple[AnalysisMethodDescriptor, ...] = (
    ...
    _available(
        ...
        module_id=AnalysisModuleId.HYPOTHESIS,
        label_ko="1-표본 동등성 검정",
        label_en="1-Sample Equivalence Test (TOST)",
        order=50,
    ),
    _available(
        method_id="hypothesis.two_sample_equivalence_tost",
        module_id=AnalysisModuleId.HYPOTHESIS,
        label_ko="2-표본 동등성 검정",
        label_en="2-Sample Equivalence Test (TOST)",
        order=60,
    ),
    _available(
        method_id="hypothesis.paired_equivalence_tost",
        module_id=AnalysisModuleId.HYPOTHESIS,
        label_ko="대응표본 동등성 검정",
        label_en="Paired Equivalence Test (TOST)",
        order=70,
    ),
    _available(
    ...
    _available(
        ...
        module_id=AnalysisModuleId.DOE,
        label_ko="일반 완전요인 설계",
        label_en="General Full Factorial Design",
        order=15,
        requires_dataset=False,
        execution_mode=AnalysisExecutionMode.DEDICATED,
    ),
