...
def create_analysis_run(
    ...
    if request.method_id == "quality.individuals_chart":
        return _run_individuals_chart_analysis(settings, request)
    if request.method_id == "quality.subgroup_chart":
        return _run_subgroup_chart_analysis(settings, request)
    if request.method_id == "quality.run_chart":
        return _run_run_chart_analysis(settings, request)
    if request.method_id == "quality.capability":
        return _run_capability_analysis(settings, request)
    if request.method_id == "quality.gage_rr":
        return _run_gage_rr_analysis(settings, request)
    if request.method_id == "quality.gage_run_chart":
        return _run_gage_run_chart_analysis(settings, request)
...
def _run_individuals_chart_analysis(
    settings: Settings,
    request: AnalysisRunRequest,
) -> AnalysisResultEnvelope:
    if request.dataset_version_id is None:
...
def _run_subgroup_chart_analysis(
    settings: Settings,
    request: AnalysisRunRequest,
) -> AnalysisResultEnvelope:
    if request.dataset_version_id is None:
...
def _run_gage_run_chart_analysis(
    settings: Settings,
    request: AnalysisRunRequest,
) -> AnalysisResultEnvelope:
    if request.dataset_version_id is None:
