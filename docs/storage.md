...
- New generic analysis-run result envelopes include runtime/build provenance fields: Python version, platform, optional `DATALAB_GIT_COMMIT`, and NumPy/SciPy package versions.
