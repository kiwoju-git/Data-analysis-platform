...
<!-- TUTORIAL_RESULT:hypothesis.two_sample_t:start -->
- **검증 source:** `hypothesis.two_sample_t` v0.1.0 · input SHA-256 `a59e3b7b52c8740e00e227fc59e3faa85b981890a78478d23aec8a4c00e6d280`
- **예상 실제 결과 (Welch, 표시 반올림):**
  - Supplier-1: N=123, mean=81.2239; Supplier-2: N=117, mean=79.4633
  - mean difference=1.7606, 95% CI [0.5084, 3.0128], p=0.006055, Hedges g=0.3570
<!-- TUTORIAL_RESULT:hypothesis.two_sample_t:end -->
- **먼저 읽을 값:** group N/mean, mean difference와 CI, Hedges g, 그 다음 p-value.
- **해석 예시:** 이 synthetic sample에서는 Supplier-1 수율 평균이 더 높고 효과는
...
<!-- TUTORIAL_RESULT:hypothesis.one_way_anova:end -->
- **먼저 읽을 값:** group mean/N, omnibus estimate와 df, effect size, post-hoc CI.
- **해석 예시:** line 간 평균 차이의 근거와 효과크기가 함께 관찰된다.
...
<!-- TUTORIAL_RESULT:categorical.one_proportion:start -->
- **검증 source:** `categorical.one_proportion` v0.1.0 · input SHA-256 `a59e3b7b52c8740e00e227fc59e3faa85b981890a78478d23aec8a4c00e6d280`
- **예상 실제 결과 (Wilson 95% CI, 표시 반올림):**
  - event `Pass`=140/240, proportion=0.5833, CI [0.5201, 0.6439]
  - p=2.011e-14, Cohen h=-0.4761
<!-- TUTORIAL_RESULT:categorical.one_proportion:end -->
...
<!-- TUTORIAL_RESULT:categorical.chi_square_association:start -->
- **검증 source:** `categorical.chi_square_association` v0.1.0 · input SHA-256 `a59e3b7b52c8740e00e227fc59e3faa85b981890a78478d23aec8a4c00e6d280`
- **예상 실제 결과 (표시 반올림):**
  - N=240, chi-square(2)=3.4969, p=0.174039, Cramer's V=0.1207
  - minimum expected=32.5000, cells below 5=0/6
<!-- TUTORIAL_RESULT:categorical.chi_square_association:end -->
...
<!-- TUTORIAL_RESULT:regression.pearson:start -->
- **검증 source:** `regression.pearson` v0.1.0 · input SHA-256 `a59e3b7b52c8740e00e227fc59e3faa85b981890a78478d23aec8a4c00e6d280`
- **예상 실제 결과 (표시 반올림):**
  - N=240, r=0.47687, 95% CI [0.37275, 0.56913], p=4.955e-15, r-squared=0.22741
<!-- TUTORIAL_RESULT:regression.pearson:end -->
<!-- TUTORIAL_RESULT:regression.xy_correlation:start -->
- **검증 source:** `regression.xy_correlation` v0.1.0 · input SHA-256 `a59e3b7b52c8740e00e227fc59e3faa85b981890a78478d23aec8a4c00e6d280`
- **X-Y 행렬 예상값:**
  - X=5개, Y=2개, pairs=10; 모든 tutorial pair N=240
<!-- TUTORIAL_RESULT:regression.xy_correlation:end -->
...
- **예상 실제 결과 (표시 반올림):**
  ...
  - row 1: mean=75.3409, mean CI [74.2981, 76.3837], prediction interval [69.9896, 80.6922]
  - row 2: mean=83.3880, mean CI [82.5815, 84.1946], prediction interval [78.0777, 88.6984]
  - row 3: mean=72.5803, mean CI [70.4758, 74.6848], prediction interval [66.9254, 78.2352]
  - row 4: mean=84.4419, mean CI [83.4327, 85.4510], prediction interval [79.0970, 89.7867]
<!-- TUTORIAL_RESULT:regression.predict:end -->
- **먼저 읽을 값:** source/target IDs, usable/excluded N, extrapolation, predicted mean,
  mean-response CI와 individual prediction interval.
- **해석 예시:** 첫 조건에서도 평균 반응의 신뢰구간보다 새 개별 관측의 예측구간이 더 넓다.
...
<!-- TUTORIAL_RESULT:quality.capability:start -->
- **검증 source:** `quality.capability` v0.1.0 · input SHA-256 `a59e3b7b52c8740e00e227fc59e3faa85b981890a78478d23aec8a4c00e6d280`
- **예상 실제 결과 (표시 반올림):**
  - N=240, LSL/Target/USL=68/82/92
  - Cp=0.8019, Cpk=0.7775, Pp=0.8026, Ppk=0.7781
<!-- TUTORIAL_RESULT:quality.capability:end -->
...
<!-- TUTORIAL_RESULT:quality.attribute_control_chart:start -->
- **검증 source:** `quality.attribute_control_chart` v0.3.0 · input SHA-256 `a59e3b7b52c8740e00e227fc59e3faa85b981890a78478d23aec8a4c00e6d280`
- **예상 실제 결과 (표시 반올림):**
  - Phase I center=0.0599591, points=240, signals=0, limit-set promoted=true
  - Phase II points=48, signals=0, dispersion available=true, ratio=1.80186
<!-- TUTORIAL_RESULT:quality.attribute_control_chart:end -->
- **먼저 읽을 값:** frozen source dependency, target N, center/LCL/UCL, strict outside signals,
  dispersion availability.
- **해석 예시:** 이 monitoring sample에는 frozen 3-sigma limits 밖 신호가 없다.
...
<!-- TUTORIAL_RESULT:quality.gage_rr:start -->
- **검증 source:** `quality.gage_rr` v0.1.0 · input SHA-256 `1a08df9c58bbc67027c522e215ed8a47f2addc7a41284af6258b7f9d7dd10b64`
- **예상 실제 결과 (표시 반올림):**
  - N=60, balanced=true, repeatability %study=3.9713, reproducibility=10.5090
  - total Gage R&R=11.2344, part-to-part=99.3669, ndc=12
<!-- TUTORIAL_RESULT:quality.gage_rr:end -->
...
<!-- TUTORIAL_RESULT:doe.factorial_design:end -->
...
- **예상 실제 결과 (표시 반올림):**
  ...
  - lack-of-fit F=0.5212, p=0.690358
<!-- TUTORIAL_RESULT:doe.response_surface:end -->
...
- **검증 source:** `doe.bayesian_optimization` v0.2.2 · input SHA-256 `a73e97ca660d4a87588ddb2aee2344b921205f4c3daf9a17ce6f876348290b91`
- **예상 실제 결과 (표시 반올림):**
...
<!-- TUTORIAL_RESULT:doe.bayesian_optimization:end -->
...
설명을 연다. 분석 화면에서는 선택 method 제목 옆 `? 이 분석 도움말`로 같은 context 설명을
