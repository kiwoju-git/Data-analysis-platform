...
1. 프론트엔드 필터 조건 UI와 cross-method filter 재사용
...
범위:
1. frontend filter controls 또는 deeper Workbench page/component split 중 하나만 선택
