...
const errorKeys: Readonly<Record<string, TranslationKey>> = {
  ...
  gp_kernel_comparison_requires_validation: "gp.selection.validationRequired",
  gp_kernel_candidates_invalid: "gp.selection.minimum",
  gp_kernel_bounds_invalid: "errors.gpGeneric",
  gp_kernel_criterion_invalid: "errors.gpGeneric",
  gp_all_kernel_candidates_failed: "gp.selection.allFailed",
  ...
  gp_time_budget_exhausted: "gp.selection.timeout",
